...
This paper introduces **Persistent Cognitive State (PCS)**: a versioned, external, evidence-addressable intermediate representation of documented cognition.
...
[BootLoader Labs](https://bll.ac) · [Second.fm](https://second.fm)
